...
static int pinmux_elkhorn_flat_left_init(const struct device *port)
{
    ARG_UNUSED(port);
...
static int pinmux_elkhorn_flat_right_init(const struct device *port)
{
    ARG_UNUSED(port);
...
SYS_INIT(pinmux_elkhorn_flat_left_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);
SYS_INIT(pinmux_elkhorn_flat_right_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);
*/